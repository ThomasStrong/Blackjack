...
It uses Spectre.Console for rendering and Newtonsoft for JSON serialization.  The planning phase is 
represented in  the repo [SWDEV1 Project Plan](https://github.com/ThomasStrong/SWDEV1_ProjectPlan).
<br></br>
